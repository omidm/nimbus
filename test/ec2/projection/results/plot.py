...
Legends = []
Legends.append('Computation(non-projection & non-control-flow)')
Legends.append('Computation(projection) & Translation(projection)')
Legends.append('Translation(non-projection & non-contrl-folw)')
Legends.append('Copy data')
Legends.append('Cache write-back')
Legends.append('Computation(control flow)')
Legends.append('Translation(control flow)')
Legends.append('Idle')
...
plt.title('PhysBAM Water Simulation Size 200 Cube with 8 Nimbus Worker Nodes(91 substeps, 5 frames)')
xticks = []
for i in range(1, N + 1):
