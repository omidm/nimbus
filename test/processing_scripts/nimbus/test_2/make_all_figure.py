...
while job_id in mydict:
    print mydict[job_id]
    plt.fill_between(
        [mydict[job_id]["f"], last_timestamp],
    ...
    plt.fill_between(
        [mydict[job_id]["r"], last_timestamp],
    ...
    if "dispatch_job(new)" in mydict[job_id]:
        plt.fill_between(
            [mydict[job_id]["dispatch_job(new)"], last_timestamp],
            [mydict[job_id]["worker"]-1]*2, [mydict[job_id]["worker"]]*2,
        ...
        plt.fill_between(
            [mydict[job_id]["dispatch_job(job_done)"], last_timestamp],
            [mydict[job_id]["worker"]-1]*2, [mydict[job_id]["worker"]]*2,
            facecolor="blue", edgecolor="blue")
