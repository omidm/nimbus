...
echo "testing the scheduler version 1 against stencil application version multi and three workers ..."
...
echo "launching stencil worker multi number 3 ...";
../stencil_worker/worker_multi 3 > worker3.txt
