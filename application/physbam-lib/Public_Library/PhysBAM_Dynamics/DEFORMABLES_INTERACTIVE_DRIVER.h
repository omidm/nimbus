...
//#####################################################################
#ifndef __DEFORMABLES_INTERACTIVE_DRIVER__
#define __DEFORMABLES_INTERACTIVE_DRIVER__    
...
template<class TV>
class DEFORMABLES_INTERACTIVE_DRIVER:public DRIVER<TV>,public NONCOPYABLE
{
    typedef typename TV::SCALAR T;
    typedef DRIVER<TV> BASE;
    typedef typename OPENGL_COMPONENT_POLICY<TV>::RIGID_GEOMETRY_COLLECTION T_RIGIDS_COMPONENT;
    typedef typename OPENGL_COMPONENT_POLICY<TV>::DEFORMABLE_BODY_COLLECTION T_DEFORMABLES_COMPONENT;
public:
