...
//#####################################################################
#include <PhysBAM_Dynamics/Coupled_Driver/COMPRESSIBLE_INCOMPRESSIBLE_DRIVER.h>
...
// Constructor
//#####################################################################
template<class TV> COMPRESSIBLE_INCOMPRESSIBLE_DRIVER<TV>::
COMPRESSIBLE_INCOMPRESSIBLE_DRIVER(COMPRESSIBLE_INCOMPRESSIBLE_EXAMPLE<TV>& example_input)
    : BASE(example_input),example(example_input)
{}
//#####################################################################
// Compute_Dt
//#####################################################################
template<class TV> typename TV::SCALAR COMPRESSIBLE_INCOMPRESSIBLE_DRIVER<TV>::
...
// Initialize
//#####################################################################
template<class TV> void COMPRESSIBLE_INCOMPRESSIBLE_DRIVER<TV>::
Initialize()
{
    BASE::Initialize();
...
{
    example.Compute_One_Over_Rho_C_Squared();
...
Advance_To_Target_Time(const T target_time)
{
    ...
    for(int substep=1;!done;substep++){
        ...
        for(int rk_substep=1;rk_substep<=example.rk_order;++rk_substep){
            ...
            rk_time=rungekutta_U.Main();rungekutta_velocities.Main();}
...
//#####################################################################
template class COMPRESSIBLE_INCOMPRESSIBLE_DRIVER<VECTOR<float,1> >;
template class COMPRESSIBLE_INCOMPRESSIBLE_DRIVER<VECTOR<float,2> >;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class COMPRESSIBLE_INCOMPRESSIBLE_DRIVER<VECTOR<double,1> >;
template class COMPRESSIBLE_INCOMPRESSIBLE_DRIVER<VECTOR<double,2> >;
#endif
