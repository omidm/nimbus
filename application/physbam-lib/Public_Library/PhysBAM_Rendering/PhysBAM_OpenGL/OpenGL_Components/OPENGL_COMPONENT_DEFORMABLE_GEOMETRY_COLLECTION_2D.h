...
public:
    ...
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_DEFORMABLE_GEOMETRY_COLLECTION_2D,Cycle_Valid_Object_Index,"Cycle valid object to be displayed");
