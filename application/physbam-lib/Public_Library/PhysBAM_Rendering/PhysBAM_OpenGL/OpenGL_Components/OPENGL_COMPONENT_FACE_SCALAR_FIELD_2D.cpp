...
OPENGL_COMPONENT_FACE_SCALAR_FIELD_2D(const GRID<TV> &grid_input, const std::string &values_filename_input, OPENGL_COLOR_MAP<T2>* color_map_input,bool is_moving_grid_input,std::string rigid_grid_frame_filename_input)
    :OPENGL_COMPONENT("Face Scalar Field 2D"), opengl_scalar_field(grid_input,*new ARRAY<T2,FACE_INDEX<2> >,color_map_input,is_moving_grid_input),values_filename(values_filename_input), x_face_values_filename(""), y_face_values_filename(""),  frame_loaded(-1), valid(false),is_moving_grid(is_moving_grid_input),rigid_grid_frame_filename(rigid_grid_frame_filename_input)
{
...
template<class T,class T2,class RW> OPENGL_COMPONENT_FACE_SCALAR_FIELD_2D<T,T2,RW>::
OPENGL_COMPONENT_FACE_SCALAR_FIELD_2D(const GRID<TV> &grid_input, const std::string &x_face_values_filename_input, const std::string &y_face_values_filename_input,OPENGL_COLOR_MAP<T2>* color_map_input,bool is_moving_grid_input,std::string rigid_grid_frame_filename_input)
    :OPENGL_COMPONENT("Face Scalar Field 2D"), opengl_scalar_field(grid_input,*new ARRAY<T2,FACE_INDEX<2> >,color_map_input,is_moving_grid_input),values_filename(), x_face_values_filename(x_face_values_filename_input), y_face_values_filename(y_face_values_filename_input),frame_loaded(-1), valid(false),is_moving_grid(is_moving_grid_input),rigid_grid_frame_filename(rigid_grid_frame_filename_input)
{
