...
public:
    OPENGL_COMPONENT_FACE_SCALAR_FIELD_2D(const GRID<TV> &grid_input,const std::string &values_filename_input,OPENGL_COLOR_MAP<T2>* color_map_input,bool is_moving_grid_input=false,std::string rigid_grid_frame_filename_input="");
    OPENGL_COMPONENT_FACE_SCALAR_FIELD_2D(const GRID<TV> &grid_input,const std::string &x_face_values_filename_input,const std::string &y_face_values_filename_input,OPENGL_COLOR_MAP<T2>* color_map_input,bool is_moving_grid_input=false,std::string rigid_grid_frame_filename_input="");
