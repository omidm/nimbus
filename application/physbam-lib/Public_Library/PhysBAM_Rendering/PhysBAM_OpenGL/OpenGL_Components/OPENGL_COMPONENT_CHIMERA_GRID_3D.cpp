...
//#####################################################################
// OPENGL_COMPONENT_CHIMERA_GRID_3D
//#####################################################################
template<class T,class RW> OPENGL_COMPONENT_CHIMERA_GRID_3D<T,RW>::
OPENGL_COMPONENT_CHIMERA_GRID_3D(const std::string filename_set_input,bool is_moving_grid_input,std::string rigid_grid_frame_filename_set_input):OPENGL_COMPONENT("Chimera Area"),filename_set(filename_set_input),frame_loaded(-1),valid(false),current_grid(1),draw_all_grids(true),is_moving_grid(is_moving_grid_input),rigid_grid_frame_filename_set(rigid_grid_frame_filename_set_input)
{
    ...
    for(int j=1;j<=opengl_grids.m;j++)
        opengl_grids(j)=new OPENGL_GRID_3D<T>(*(new GRID<TV>),OPENGL_COLOR::Gray(.5),is_moving_grid_input);
...
// Valid_Frame
//#####################################################################
template<class T,class RW> bool OPENGL_COMPONENT_CHIMERA_GRID_3D<T,RW>::
...
// Set_Frame
//#####################################################################
template<class T,class RW> void OPENGL_COMPONENT_CHIMERA_GRID_3D<T,RW>::
...
// Bounding_Box
//#####################################################################
template<class T,class RW> RANGE<VECTOR<float,3> > OPENGL_COMPONENT_CHIMERA_GRID_3D<T,RW>::
Bounding_Box() const
{
...
//#####################################################################
template<class T,class RW> OPENGL_SELECTION* OPENGL_COMPONENT_CHIMERA_GRID_3D<T,RW>::
...
Next_Grid()
{
    ...
    chimera_slice->current_grid=current_grid;
    std::stringstream ss;
...
{
    for(int i=1;i<=opengl_grids.Size();i++)
        opengl_grids(i)->draw_ghost_values=!opengl_grids(i)->draw_ghost_values;
}
//#####################################################################
template class OPENGL_COMPONENT_CHIMERA_GRID_3D<float,float>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class OPENGL_COMPONENT_CHIMERA_GRID_3D<double,double>;
#endif
