...
#include <PhysBAM_Rendering/PhysBAM_OpenGL/OpenGL_Components/OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D.h>
#include <PhysBAM_Rendering/PhysBAM_OpenGL/OpenGL/OPENGL_CONSTANT_COLOR_MAP.h>
using namespace PhysBAM;
//#####################################################################

template<class T,class T2,class RW> OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<T,T2,RW>::
OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D(const ARRAY<GRID<TV> > &grid_input, const std::string &values_filename_set_input, OPENGL_COLOR_MAP<T2>* color_map_input,bool is_moving_grid_input,std::string rigid_grid_frame_filename_set_input)
    :OPENGL_COMPONENT("Face Scalar Field 2D"),
    values_filename_set(values_filename_set_input), frame_loaded(-1), valid(false), current_grid(1),draw_all_grids(true),display_in_bool(false),is_moving_grid(is_moving_grid_input),rigid_grid_frame_filename_set(rigid_grid_frame_filename_set_input)
{
    for(int i=1;i<=grid_input.Size();i++){
        OPENGL_FACE_SCALAR_FIELD_2D<T,T2>* tmp_opengl_scalar_field=new OPENGL_FACE_SCALAR_FIELD_2D<T,T2>(grid_input(i),*new ARRAY<T2,FACE_INDEX<2> >,color_map_input,is_moving_grid_input);
        OPENGL_FACE_SCALAR_FIELD_2D<T,bool>* tmp_opengl_bool_field=new OPENGL_FACE_SCALAR_FIELD_2D<T,bool>(grid_input(i),*new ARRAY<bool,FACE_INDEX<2> >,new OPENGL_CONSTANT_COLOR_MAP<bool>(OPENGL_COLOR::Cyan()),is_moving_grid_input);
...
template<class T,class T2,class RW> bool OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<T,T2,RW>::
Valid_Frame(int frame_input) const
{
    return FILE_UTILITIES::File_Exists(STRING_UTILITIES::string_sprintf(values_filename_set.c_str(),frame_input,1));
}

template<class T,class T2,class RW> void OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<T,T2,RW>::
...
template<class T,class T2,class RW> RANGE<VECTOR<float,3> > OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<T,T2,RW>::
Bounding_Box() const
{
...
template class OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<float,int,float>;
template class OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<float,bool,float>;
template class OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<float,float,float>;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<double,int,double>;
template class OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<double,bool,double>;
template class OPENGL_COMPONENT_CHIMERA_FACE_SCALAR_FIELD_2D<double,double,double>;
#endif
