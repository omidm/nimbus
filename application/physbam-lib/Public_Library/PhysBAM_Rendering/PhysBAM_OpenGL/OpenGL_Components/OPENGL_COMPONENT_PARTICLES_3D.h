...
{
public:
    OPENGL_COMPONENT_PARTICLES_3D(const std::string &filename, const std::string &filename_set_input="", bool use_ids_input = true, bool particles_stored_per_cell_input = false, bool particles_stored_per_cell_adaptive_input=false, bool use_chimera_grid_input=false,bool is_moving_grid_input=false,const std::string rigid_grid_frame_filename_set_input="");
...
public:
    ...
    ARRAY<VECTOR<T,3> > velocities;
    ARRAY<FRAME<VECTOR<T,3> > > rigid_grid_frames;
