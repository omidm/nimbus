...
public:
    OPENGL_COMPONENT_MAC_VELOCITY_FIELD_2D(const GRID<TV> &grid,const std::string &velocity_filename_input,const std::string directory_adaptive_input="",const std::string filename_active_cells_input="",const std::string filename_active_faces_input="",bool is_moving_grid_input=false,std::string rigid_grid_frame_filename_input="");
    OPENGL_COMPONENT_MAC_VELOCITY_FIELD_2D(const GRID<TV> &grid,const std::string &velocity_filename_input,const std::string directory_adaptive_input,const std::string filename_active_cells_input,const std::string filename_active_faces_input,const ARRAY<GRID<TV>*> grid_array_input,bool is_moving_grid_input=false,std::string rigid_grid_frame_filename_input="");
    ...
    void Print_Weights_I(std::ostream& stream,const FACE_INDEX<2>& face) const;
    void Print_Weights_J(std::ostream& stream,const FACE_INDEX<2>& face) const;
