...
public:
    ...
    DEFORMABLE_GEOMETRY_COLLECTION<TV> *deformable_geometry,*deformable_geometry_simulated;
    ...
    OPENGL_COMPONENT_DEFORMABLE_GEOMETRY_COLLECTION_3D(const bool initialize_geometry=true);
    ...
    void Reinitialize_From_Simulation(bool force=false,bool read_geometry=true);
