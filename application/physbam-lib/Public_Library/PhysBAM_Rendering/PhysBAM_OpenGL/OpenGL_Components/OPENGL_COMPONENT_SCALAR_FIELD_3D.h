...
public:
    ...
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_SCALAR_FIELD_3D, Toggle_Increase_Color_Map_Range, "Toggle increase color map range");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_SCALAR_FIELD_3D, Toggle_Decrease_Color_Map_Range, "Toggle decrease color map range");
