...
public:
    ...
    {homogeneous_position[0]=(GLfloat)position.x;homogeneous_position[1]=(GLfloat)position.y;homogeneous_position[2]=(GLfloat)position.z;homogeneous_position[3]=(GLfloat)finite_position;}
