...
//#####################################################################
OPENGL_WINDOW_GLUT::
OPENGL_WINDOW_GLUT(GLUT_RENDER_WORLD& opengl_world_input,const std::string& window_title_input,const int width_input,const int height_input)
...
{
    if(single->opengl_world.getPromptMode()) single->opengl_world.Handle_Keypress_Prompt(key);
