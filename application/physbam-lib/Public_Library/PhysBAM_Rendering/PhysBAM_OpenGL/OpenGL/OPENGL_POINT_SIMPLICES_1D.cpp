...
OPENGL_POINT_SIMPLICES_1D(const POINT_SIMPLICES_1D<T>& simplices_input,const OPENGL_COLOR &color_input)
    ...
    vertex_color(OPENGL_COLOR::Green(0.9f)),segment_color(OPENGL_COLOR::Blue(0.9f)),vertex_position_color(OPENGL_COLOR::Magenta()),
...
{
    float xmin,xmax;
    xmin=xmax=(float)simplices.particles.X(1).x;
