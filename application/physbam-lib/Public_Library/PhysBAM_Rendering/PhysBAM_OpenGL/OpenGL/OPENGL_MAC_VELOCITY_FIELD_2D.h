...
public:
    ...
    using OPENGL_VECTOR_FIELD_2D<ARRAY<TV> >::size;using OPENGL_VECTOR_FIELD_2D<ARRAY<TV> >::is_moving_grid;using OPENGL_VECTOR_FIELD_2D<ARRAY<TV> >::rigid_grid_frame; 
    ...
    OPENGL_MAC_VELOCITY_FIELD_2D(GRID<TV> &grid,ARRAY<T,FACE_INDEX<2> > &face_velocities_input,T_ARRAYS_BOOL *active_cells_input=0,T_FACE_ARRAYS_BOOL *active_faces_input=0,bool is_moving_grid_input=false);
