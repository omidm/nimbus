...
public:
    ...
    static void Handle_Pinch_Android(int button,int state,int x,int y);
    static void Handle_Drag_Android(int x,int y);
    static void Get_Camera(VECTOR<float,3> &camera,VECTOR<float,3> &target,VECTOR<float,3> &up);
    static void Set_Camera(VECTOR<float,3> camera,VECTOR<float,3> target,VECTOR<float,3> up);
//#####################################################################
};
}
#endif
