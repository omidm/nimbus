//#####################################################################
// Copyright 2007-2012, Geoffrey Irving, Craig Schroeder, Rahul Sheth.
...
template<class T,int m,int n> struct PRODUCT<VECTOR<T,m>,MATRIX<T,m,n> >{typedef VECTOR<T,n> TYPE;};
template<class T,int d> struct PRODUCT<VECTOR<T,d>,DIAGONAL_MATRIX<T,d> >{typedef VECTOR<T,d> TYPE;};
template<class T,int d> struct PRODUCT<VECTOR<T,d>,SYMMETRIC_MATRIX<T,d> >{typedef VECTOR<T,d> TYPE;};
template<class T,int d> struct PRODUCT<VECTOR<T,d>,UPPER_TRIANGULAR_MATRIX<T,d> >{typedef VECTOR<T,d> TYPE;};
template<class T,int d> struct PRODUCT<VECTOR<T,d>,MATRIX_MXN<T> >{typedef VECTOR_ND<T> TYPE;};

template<class T,int m,int n> struct PRODUCT<VECTOR_ND<T>,MATRIX<T,m,n> >{typedef VECTOR_ND<T> TYPE;};
template<class T,int d> struct PRODUCT<VECTOR_ND<T>,DIAGONAL_MATRIX<T,d> >{typedef VECTOR_ND<T> TYPE;};
template<class T,int d> struct PRODUCT<VECTOR_ND<T>,SYMMETRIC_MATRIX<T,d> >{typedef VECTOR_ND<T> TYPE;};
template<class T,int d> struct PRODUCT<VECTOR_ND<T>,UPPER_TRIANGULAR_MATRIX<T,d> >{typedef VECTOR_ND<T> TYPE;};
template<class T> struct PRODUCT<VECTOR_ND<T>,MATRIX_MXN<T> >{typedef VECTOR_ND<T> TYPE;};
