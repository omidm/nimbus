...
//#####################################################################
    ...
    virtual void Fill_Ghost_Cells_Node(const T_GRID& grid,const T_ARRAYS_T2& u,T_ARRAYS_T2& u_ghost,const T dt,const T time,const int number_of_ghost_cells);// note: grid must be a regular grid
    ...
    virtual void Fill_Single_Ghost_Region_Threaded(RANGE<TV_INT>& region,const T_GRID& grid,T_ARRAYS_T2& u_ghost,const int side);
//#####################################################################
};
}
#endif
