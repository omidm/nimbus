//#####################################################################
// Copyright 2004-2011, Zhaosheng Bao, Ron Fedkiw, Jon Gretarsson, Geoffrey Irving, Michael Lentine, Andrew Selle, Jonathan Su, Joseph Teran.
...
protected:
    ...
    template<class T_THICKNESS> void Intersection_List(const TV& point,ARRAY<int>& intersection_list,const T_THICKNESS thickness_over_two) const;
    ...
    template<class T_VISITOR,class T_THICKNESS> void Intersection_List(const FRAME<TV>& frame,const FRAME<TV>& other_frame,const BOX_HIERARCHY<TV>& other_hierarchy,T_VISITOR& visitor,const int self_box,const int other_box,
        const T_THICKNESS extra_thickness=ZERO()) const;
    template<class T_VISITOR,class T_THICKNESS> void Swept_Intersection_List(const VECTOR<FRAME<TV>,2>& frame,const VECTOR<FRAME<TV>,2>& other_frame,const BOX_HIERARCHY<TV>& other_hierarchy,T_VISITOR& visitor,const int self_box,
        const int other_box,const T_THICKNESS extra_thickness=ZERO()) const;
public:
    ...
    template<class T_VISITOR,class T_THICKNESS> void Intersection_List(const FRAME<TV>& frame,const FRAME<TV>& other_frame,const BOX_HIERARCHY<TV>& other_hierarchy,T_VISITOR& visitor,const T_THICKNESS extra_thickness=ZERO()) const;
    template<class T_VISITOR,class T_THICKNESS> void Swept_Intersection_List(const VECTOR<FRAME<TV>,2>& frame,const VECTOR<FRAME<TV>,2>& other_frame,const BOX_HIERARCHY<TV>& other_hierarchy,T_VISITOR& visitor,const T_THICKNESS extra_thickness=ZERO()) const;
