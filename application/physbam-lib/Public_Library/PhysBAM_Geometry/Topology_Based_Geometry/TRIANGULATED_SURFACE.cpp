...
//#####################################################################
template<class T> void TRIANGULATED_SURFACE<T>::
Initialize_Sphere_Mesh_And_Particles(const int m,const int n,const T radius)
{
    TOPOLOGY_BASED_GEOMETRY_COMPUTATIONS::Initialize_Sphere_Mesh_And_Particles(*this,m,n,radius);
}
//#####################################################################
