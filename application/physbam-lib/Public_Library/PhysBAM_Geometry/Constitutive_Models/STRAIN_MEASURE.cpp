...
{   
    ...
    std::stringstream ss;
    ss<<"strain measure - total elements = "<<altitude.m<<std::endl;
    ss<<"strain measure - smallest altitude = "<<altitude(1)<<std::endl;
    ss<<"strain measure - one percent altitude = "<<altitude((int)(.01*altitude.m)+1)<<std::endl;
    ss<<"strain measure - ten percent altitude = "<<altitude((int)(.1*altitude.m)+1)<<std::endl;
    ss<<"strain measure - median altitude = "<<altitude((int)(.5*altitude.m)+1)<<std::endl;
    LOG::filecout(ss.str());
}
//#####################################################################
