...
//#####################################################################
    void Extrapolate(const T time=0,const bool fill_ghost_cells=true,const bool interpolate_high_low=false);
private:
    ...
    void Update_Close_Point(T_ARRAYS_T2_BASE& u,const T_ARRAYS_BASE& phi,const T_ARRAYS_BOOL_BASE& done,const TV_INT& index,const bool interpolate_high_low);
//#####################################################################
}; 
}  
#endif
