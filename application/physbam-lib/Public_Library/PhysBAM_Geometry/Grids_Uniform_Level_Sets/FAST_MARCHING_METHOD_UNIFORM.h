...
//#####################################################################
    void Fast_Marching_Method_Threaded_Part_One(int tid,RANGE<TV_INT>& domain,T_ARRAYS_SCALAR& phi_ghost,ARRAY<T_ARRAYS_SCALAR>& phi_new_array);
    void Fast_Marching_Method_Threaded_Part_Two(int tid,RANGE<TV_INT>& domain,T_ARRAYS_SCALAR& phi_ghost,ARRAY<T_ARRAYS_SCALAR>& phi_new_array,const T stopping_distance,const ARRAY<TV_INT>* seed_indices,const bool add_seed_indices_for_ghost_cells);
