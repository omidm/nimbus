...
public:
        ...
        fire_voxels(fire_voxels_input),fire_shader(fire_shader_input)
    {
        ...
        LOG::filecout("    Generating CDF for Pr(z|x,y)");
        ...
        LOG::filecout("    Generating CDF for Pr(y|x)");
        ...
        LOG::filecout("    Generating CDF for Pr(x)...\n");
        ...
        std::stringstream ss;
        ss<<"x_cdf normalization "<<x_cdf.normalization_constant<<" total_power "<<total_average_power<<std::endl;
        LOG::filecout(ss.str());
    }
