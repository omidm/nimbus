...
public:
    ...
    std::stringstream ss;
    ss<<"RENDERING_SHOCKS"<<std::endl;
    ss<<"gradient_threshold="<<gradient_threshold<<", refraction_multiplier="<<refraction_multiplier<<std::endl;
    ss<<"volumetric_step="<<volumetric_step<<", fine_volumetric_step="<<fine_volumetric_step<<", skip_next_intersection_factor="<<skip_next_intersection_factor<<std::endl;
    ss<<"use_pressure_for_intersection="<<use_pressure_for_intersection<<", use_pressure_for_rarefaction="<<use_pressure_for_rarefaction<<std::endl;
    LOG::filecout(ss.str());
    }
