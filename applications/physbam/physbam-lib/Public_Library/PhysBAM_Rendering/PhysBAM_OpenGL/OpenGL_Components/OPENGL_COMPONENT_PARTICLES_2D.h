...
{
public:
    OPENGL_COMPONENT_PARTICLES_2D(const std::string &filename, const std::string &filename_set_input="", bool use_ids_input = true, bool particles_stored_per_cell_uniform_input = false, bool is_moving_grid_input=false, const std::string &rigid_grid_frame_filename_input="");
    ...
    void Toggle_Increase_Vector_Size();
    void Toggle_Decrease_Vector_Size();
    void Command_Prompt();
    void Next_Set();
    void Previous_Set();
    ...
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_PARTICLES_2D, Toggle_Increase_Vector_Size, "Toggle increase vector size");
    DEFINE_COMPONENT_CALLBACK(OPENGL_COMPONENT_PARTICLES_2D, Toggle_Decrease_Vector_Size, "Toggle decrease vector size");
...
public:
    ...
    ARRAY<VECTOR<T,2> > velocities;
    ARRAY<FRAME<VECTOR<T,2> > > rigid_grid_frames;
