...
public:
    ...
    RIGID_GEOMETRY_COLLECTION<TV>* rigid_geometry_collection_simulation;
...
protected:
    ...
    mutable ARRAY<bool,int> draw_object;
...
public:
    OPENGL_COMPONENT_RIGID_GEOMETRY_COLLECTION_3D(bool use_display_lists=true,const bool initialize_geometry=true);
    ...
    virtual void Reinitialize_From_Simulation(const bool force=false);
...
template<class T>
class OPENGL_SELECTION_COMPONENT_RIGID_GEOMETRY_COLLECTION_3D:public OPENGL_SELECTION, public SELECTION_RIGID_BODY<VECTOR<T, 3> >
{
public:
    int body_id;
    ...
    VECTOR<T, 3> Get_Object_Location() {
        return VECTOR<T, 3>(OPENGL_WORLD::Singleton()->object_location(1),
                            OPENGL_WORLD::Singleton()->object_location(2),
                            OPENGL_WORLD::Singleton()->object_location(3));
    }

    bool Was_Dragged() {
        return OPENGL_WORLD::Singleton()->drag_current_selection;
    }
