...
public:
    ...
    bool is_moving_grid;
    FRAME<VECTOR<T,3> > rigid_grid_frame;
#ifndef USE_OPENGLES
    ...
    OPENGL_VECTOR_FIELD_3D(ARRAY<VECTOR<T,3> >& field,ARRAY<VECTOR<T,3> >& locations, 
        ...
        draw_arrowhead(draw_arrowhead),draw_value(draw_value),draw_basepoint(draw_basepoint),draw_fancy_arrow(draw_fancy_arrow),is_moving_grid(false)
#ifndef USE_OPENGLES
        ,vector_hat(0)
#endif
    {}
