...
OPENGL_FACE_SCALAR_FIELD_3D(const GRID<TV> &grid_input,ARRAY<T2,FACE_INDEX<3> > &face_values_input,OPENGL_COLOR_MAP<T2> *color_map_input,bool is_moving_grid_input)
    ...
    color_map(color_map_input), scale(1), is_moving_grid(is_moving_grid_input), opengl_points(*new ARRAY<VECTOR<T,3> >)
{
