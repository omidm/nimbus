...
template<class T,class SCALAR,class ENABLER=void> struct REPLACE_FLOATING_POINT{typedef T TYPE;}; //fix for Windows, shouldn't be required but can't include RIGID_GEOMETRY.h wihout errors
