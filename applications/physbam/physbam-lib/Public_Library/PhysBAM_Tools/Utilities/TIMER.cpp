...
//#####################################################################
// Function Get_Accumulated_Time
//#####################################################################
double TIMER::
Get_Accumulated_Time(const int id)
{
...
//#####################################################################
void TIMER::
Reset_Accumulated_Time(const int id)
{
    timers(id).accumulator=0;
}
//#####################################################################
...
Print_Stats(const int id,const char* str)
{
    ...
    std::stringstream ss;
    ss<<"Total elapsed time for "<<str<<" is "<<timers(id).accumulator*resolution*.001<<" s."<<std::endl;
    LOG::filecout(ss.str());
#endif
}
//#####################################################################
