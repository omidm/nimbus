...
#define INSTANTIATION_HELPER(T) \
    ...
    template VECTOR<T,1> RANDOM_NUMBERS<T>::Get_Uniform_Vector<1>(T const,T const); \
    template VECTOR<T,2> RANDOM_NUMBERS<T>::Get_Uniform_Vector<2>(T const,T const); \
    template VECTOR<T,3> RANDOM_NUMBERS<T>::Get_Uniform_Vector<3>(T const,T const); \
    template FRAME<VECTOR<T,1> > RANDOM_NUMBERS<T>::Get_Frame(const VECTOR<T,1>&, const VECTOR<T,1>&); \
    template FRAME<VECTOR<T,2> > RANDOM_NUMBERS<T>::Get_Frame(const VECTOR<T,2>&, const VECTOR<T,2>&); \
    template FRAME<VECTOR<T,3> > RANDOM_NUMBERS<T>::Get_Frame(const VECTOR<T,3>&, const VECTOR<T,3>&);
