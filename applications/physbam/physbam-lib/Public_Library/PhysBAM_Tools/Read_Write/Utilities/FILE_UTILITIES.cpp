...
{if(!Directory_Exists(dirname)){
        ...
        std::string command="mkdir "+newDir;
    if(system(command.c_str()) || !Directory_Exists(newDir)){LOG::cerr<<"Failed!"<<std::endl;throw FILESYSTEM_ERROR("Create_Directory failed");return false;}
