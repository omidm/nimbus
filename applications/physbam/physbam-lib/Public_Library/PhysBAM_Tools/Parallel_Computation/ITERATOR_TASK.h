...
public:
    ...
    void (TYPE::*tidfunc)(int,T_ITERATOR&,T1,T2);
    T_ITERATOR iterator;
    T1 arg1;T2 arg2;
    int tid;
    ...
    ITERATOR_TASK_2(TYPE& class_input,void (TYPE::*func_input)(T_ITERATOR&,T1,T2),const T_ITERATOR& iterator_input,T1 arg1_input,T2 arg2_input)
        :my_class(class_input),func(func_input),tidfunc(0),iterator(iterator_input),arg1(arg1_input),arg2(arg2_input)
    {}
    
    ITERATOR_TASK_2(TYPE& class_input,void (TYPE::*func_input)(int,T_ITERATOR&,T1,T2),int tid_input,const T_ITERATOR& iterator_input,T1 arg1_input,T2 arg2_input)
        :my_class(class_input),func(0),tidfunc(func_input),iterator(iterator_input),arg1(arg1_input),arg2(arg2_input),tid(tid_input)
    {}
    
    void Run(const int threadid)
    {
        if(tidfunc) (my_class.*tidfunc)(tid,iterator,arg1,arg2);
        else (my_class.*func)(iterator,arg1,arg2);
    }
};
...
public:
    ...
    void (TYPE::*tidfunc)(int,T_ITERATOR&,T1,T2,T3,T4,T5);
    T_ITERATOR iterator;
    T1 arg1;T2 arg2;T3 arg3;T4 arg4;T5 arg5;
    int tid;
    ...
    ITERATOR_TASK_5(TYPE& class_input,void (TYPE::*func_input)(T_ITERATOR&,T1,T2,T3,T4,T5),const T_ITERATOR& iterator_input,T1 arg1_input,T2 arg2_input,T3 arg3_input,T4 arg4_input,T5 arg5_input)
        :my_class(class_input),func(func_input),tidfunc(0),iterator(iterator_input),arg1(arg1_input),arg2(arg2_input),arg3(arg3_input),arg4(arg4_input),arg5(arg5_input)
    {}
    
    ITERATOR_TASK_5(TYPE& class_input,void (TYPE::*func_input)(int,T_ITERATOR&,T1,T2,T3,T4,T5),int tid_input,const T_ITERATOR& iterator_input,T1 arg1_input,T2 arg2_input,T3 arg3_input,T4 arg4_input,T5 arg5_input)
        :my_class(class_input),func(0),tidfunc(func_input),iterator(iterator_input),arg1(arg1_input),arg2(arg2_input),arg3(arg3_input),arg4(arg4_input),arg5(arg5_input),tid(tid_input)
    {}
    
    void Run(const int threadid)
    {
        if(tidfunc) (my_class.*tidfunc)(tid,iterator,arg1,arg2,arg3,arg4,arg5);
        else (my_class.*func)(iterator,arg1,arg2,arg3,arg4,arg5);
    }
};
