...
#include <PhysBAM_Dynamics/RIGIDS_INTERACTIVE_DRIVER.h>
#include <time.h>
#ifdef WIN32
    #include <windows.h>
#endif
...
// Constructor
//#####################################################################
template<class TV> RIGIDS_INTERACTIVE_DRIVER<TV>::
...
//#####################################################################
template<class TV> RIGIDS_INTERACTIVE_DRIVER<TV>::
~RIGIDS_INTERACTIVE_DRIVER()
{}
//#####################################################################
// Function Rigid_Cluster_Fracture
//#####################################################################
template<class TV> void RIGIDS_INTERACTIVE_DRIVER<TV>::
...
//#####################################################################
template<class TV> void RIGIDS_INTERACTIVE_DRIVER<TV>::Update_Positions_From_Interactive()
{ 
    if(visualizer->current_selection && visualizer->current_selection->type==OPENGL_SELECTION::COMPONENT_RIGID_BODIES_3D){
        ...
        example.rigid_body_collection.rigid_geometry_collection.particles.X(real_selection->body_id)[1]=visualizer->opengl_world.object_location(1);
        example.rigid_body_collection.rigid_geometry_collection.particles.X(real_selection->body_id)[2]=visualizer->opengl_world.object_location(2);
        example.rigid_body_collection.rigid_geometry_collection.particles.X(real_selection->body_id)[3]=visualizer->opengl_world.object_location(3);
...
Simulate_To_Frame(const int frame_input)
{
    while(frame_input<0 || current_frame<frame_input){
        std::stringstream ssf;ssf<<"Frame "<<current_frame+1;
        LOG::SCOPE scope("FRAME",ssf.str());
        Preprocess_Frame(current_frame+1);
        while(visualizer->opengl_world.drag_current_selection) Update_Positions_From_Interactive();
...
//#####################################################################
template class RIGIDS_INTERACTIVE_DRIVER<VECTOR<float,1> >;
template class RIGIDS_INTERACTIVE_DRIVER<VECTOR<float,2> >;
template class RIGIDS_INTERACTIVE_DRIVER<VECTOR<float,3> >;
#ifndef COMPILE_WITHOUT_DOUBLE_SUPPORT
template class RIGIDS_INTERACTIVE_DRIVER<VECTOR<double,1> >;
template class RIGIDS_INTERACTIVE_DRIVER<VECTOR<double,2> >;
template class RIGIDS_INTERACTIVE_DRIVER<VECTOR<double,3> >;
#endif
