...
//#####################################################################
// Class COMPRESSIBLE_INCOMPRESSIBLE_EXAMPLE_EXPLICIT
//#####################################################################
#ifndef __COMPRESSIBLE_INCOMPRESSIBLE_EXAMPLE_EXPLICIT__
#define __COMPRESSIBLE_INCOMPRESSIBLE_EXAMPLE_EXPLICIT__
...
template<class TV>
class COMPRESSIBLE_INCOMPRESSIBLE_EXAMPLE_EXPLICIT:public EXAMPLE<TV>, public LEVELSET_CALLBACKS<GRID<TV> >
{
  ...
  public:
    ...
    T_ARRAYS_SCALAR pressure,compressible_pressure,entropy;
    T_ARRAYS_BOOL psi;
    ...
    POISSON_UNIFORM<T_GRID> projection;
    ...
    virtual ~COMPRESSIBLE_INCOMPRESSIBLE_EXAMPLE_EXPLICIT();
...
//#####################################################################
    ...
    virtual void Update_Psi_And_Extrapolate_State_Into_Incompressible_Flow(const T dt,const T time);
//#####################################################################
    ...
    void Apply_Pressure(T_ARRAYS_SCALAR& p_ghost,const T dt,const T time);
...
#endif // __COMPRESSIBLE_INCOMPRESSIBLE_EXAMPLE_EXPLICIT__
