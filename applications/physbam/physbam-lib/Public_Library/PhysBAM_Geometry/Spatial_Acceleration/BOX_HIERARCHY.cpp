...
//#####################################################################
template<class TV> template<class T_THICKNESS> void BOX_HIERARCHY<TV>::
Intersection_List(const TV& point,ARRAY<int>& intersection_list,const T_THICKNESS thickness_over_two) const
{
...
#define INSTANTIATION_HELPER(T,d) \
    ...
    template void BOX_HIERARCHY<VECTOR<T,d> >::Intersection_List<T>(const int,const VECTOR<T,d>&,ARRAY<int>&,const T) const; \
    template void BOX_HIERARCHY<VECTOR<T,d> >::Intersection_List<T>(const int,const RANGE<VECTOR<T,d> >&,ARRAY<int>&,const T) const;
