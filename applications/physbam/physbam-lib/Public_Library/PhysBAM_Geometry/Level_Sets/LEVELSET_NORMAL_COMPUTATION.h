//#####################################################################
// Copyright 2002-2011, Robert Bridson, Ronald Fedkiw, Eran Guendelman, Neil Molino, Igor Neverov, Linhai Qiu.
...
template<class T_GRID> class LEVELSET_RIGID_GRID_3D;
...
//#####################################################################
    ...
    virtual VECTOR<T,3> Compute_Normal(const LEVELSET_RIGID_GRID_3D<T_GRID>& levelset,const VECTOR<T,3>& location) const {PHYSBAM_FUNCTION_IS_NOT_DEFINED();}
//#####################################################################
};
}
#endif
