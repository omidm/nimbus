...
#define DIMENSION_READ_WRITE_HELPER(T,RW) \
    ...
    Read_Write<STRUCTURE<VECTOR<T,2> >,RW>::Register_Read_Write<ANALYTIC_IMPLICIT_OBJECT<ELLIPSE<T> > >(); \
    Read_Write<STRUCTURE<VECTOR<T,3> >,RW>::Register_Read_Write<ANALYTIC_IMPLICIT_OBJECT<ELLIPSOID<T> > >(); \
