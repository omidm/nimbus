...
//#####################################################################
template<class T>
struct TOPOLOGY_BASED_SIMPLEX_POLICY<VECTOR<T,2>,2>
{
    typedef typename TOPOLOGY_BASED_GEOMETRY_POLICY<VECTOR<T,2> >::TRIANGULATED_OBJECT OBJECT;
    typedef TRIANGLE_HIERARCHY_2D<T> HIERARCHY;
};
template<class TV>
