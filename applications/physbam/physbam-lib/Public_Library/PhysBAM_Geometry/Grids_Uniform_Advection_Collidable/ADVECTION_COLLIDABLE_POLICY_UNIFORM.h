...
public:
    // collidable
    typedef ADVECTION_SEMI_LAGRANGIAN_COLLIDABLE_CELL_UNIFORM<T_GRID,T,FACE_LOOKUP_COLLIDABLE_UNIFORM<T_GRID,FACE_LOOKUP_UNIFORM<T_GRID> > > ADVECTION_SEMI_LAGRANGIAN_COLLIDABLE_CELL;
    typedef ADVECTION_SEMI_LAGRANGIAN_COLLIDABLE_FACE_UNIFORM<T_GRID,FACE_LOOKUP_COLLIDABLE_UNIFORM<T_GRID,FACE_LOOKUP_UNIFORM<T_GRID> > > ADVECTION_SEMI_LAGRANGIAN_COLLIDABLE_FACE;
    // slip collidable
