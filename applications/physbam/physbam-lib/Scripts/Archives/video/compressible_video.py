...
def Make_Slides():
    ...
    slide("spherical_four_walls_bottom.png",36,
             ["Full Simulation",
             "Different View"
             ])

    slide("spherical_four_walls_fracture.png",36,
            [(45,"Shock in a",header_color),
             (45,"Detonation Chamber",header_color),
...
def Make_Video(video_dir):
    ...
    video.add_directory(final_render_base+"/spherical_4_walls/renders_top_view",0,200,1)

    video.composite_slide_on_current_frame("spherical_four_walls2.png","spherical_four_walls2_composite.png",one_second*6)
    video.add_directory(final_render_base+"/spherical_4_walls/renders_top_view",200,3000,10)

    video.add_frame("spherical_four_walls3.png",caption_length)
    video.add_directory(final_render_base+"/spherical_4_walls/renders_top_view",0,3000,10)

    video.add_frame("spherical_four_walls_bottom.png",caption_length)
    video.add_directory(final_render_base+"/spherical_4_walls/renders_bottomview",0,3000,10)

    # Fracture
    video.add_frame("spherical_four_walls_fracture.png",caption_length)
    video.add_directory(final_render_base+"/spherical_4_walls_fracture/output_hq",0,3000,10)

    #video.add_frame("spherical_four_walls_fracture_zoom.png",caption_length)
    #video.add_directory(final_render_base+"/spherical_4_walls_fracture/output_zoomed_with_fire_hq",0,110,1)

    video.add_frame("spherical_four_walls_fracture_zoom_nofire.png",one_second*5)
    video.add_directory(final_render_base+"/spherical_4_walls_fracture/output_zoomed_hq",0,110,1)
