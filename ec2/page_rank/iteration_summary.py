...
parser.add_argument(
    ...
    dest="startiter",
    default=0,
    help="initial iterations to ignore")
parser.add_argument(
    "-ei", "--end_iter",
    dest="enditer",
    default=-1,
    help="number of iterations to consider")
parser.add_argument(
    "-v", "--verbose",
    dest="collapse",
    action="store_true",
...
for rank in range(1, N+1):
  ...
  print 'Ave {:4.0f}: {:8.0f} {:8.2f} {:8.2f} {:8.2f}  {:8.2f} {:8.2f} {:8.2f}  {:8.2f}'.format(
